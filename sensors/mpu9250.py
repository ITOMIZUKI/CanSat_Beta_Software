...
class SL_MPU9250:
    ...
    def read(self, name=False)->"return sensor data, (acc_x, acc_y, acc_z, gyr_x, gyr_y, gyr_z, mag_x, mag_y, mag_z)":
            '''
            ...
            data = acc[0], acc[1], acc[2], gyr[0], gyr[1], gyr[2], mag[0] ,mag[1] ,mag[2]

            if name == True:
                data_name = "acc_x", "acc_y", "acc_z", "gyr_x", "gyr_y", "gyr_z", "mag_x", "mag_y", "mag_z"
