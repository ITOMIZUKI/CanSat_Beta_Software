...
class Codec:
    ...
    def __init__(self, tags:tuple, packet:int=64):
        """
        tags: a tuple or list including tugs of data
    ...
    def reshape_data(data:list)-> "reshaped data:float":
        ...
        --------------------------------------------------
        return reshaped data of a float
        """
    ...
    def decoder(self, data:str)-> "flag:str, data_decoded:dict":
        ...
        while data != []:
            tag, data_list, data = self.extract_data(data)    
            data_decoded[tag] = Codec.reshape_data(data_list)           # append a tag and data
